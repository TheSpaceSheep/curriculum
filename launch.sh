...
python -m egg.zoo.compo_vs_generalization.train --n_epochs=10 --n_values=5 --n_attributes=3 --vocab_size=3 --max_len=20 --batch_size=5120 --sender_cell=lstm --receiver_cell=lstm --random_seed=1
