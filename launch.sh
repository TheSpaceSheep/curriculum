...
python -m egg.zoo.compo_vs_generalization.train --n_epochs=10 --n_attributes=5 --n_values=3 --vocab_size=20 --max_len=20 --batch_size=5120 --sender_cell=lstm --receiver_cell=lstm --random_seed=1 --data_scaler=1 --train_size=10 --test_size=5 --validation_size=5
